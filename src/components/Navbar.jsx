...
export default function Navbar() {
  ...
  const clusterStatuses = [
    {
      text: "15/15 K8s Clusters Online",
      color: "bg-emerald-500",
      textColor: "text-emerald-700",
    },
    {
      text: "AWS EKS: 8/8 Active",
      color: "bg-cyan-500",
      textColor: "text-cyan-700",
    },
    {
      text: "Azure AKS: 4/4 Active",
      color: "bg-blue-500",
      textColor: "text-blue-700",
    },
    {
      text: "GCP GKE: 3/3 Active",
      color: "bg-indigo-500",
   ...
   *
   * We use hash URLs instead of routes because this portfolio
   * is hosted as a Vite SPA on GitHub Pages.
   *
   * Example:
   * /deepak-portfolio/#skills
   ...
   *
   * We do NOT use window.history.pushState().
   * The URL uses #section instead of /section.
   */
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0 min-w-0">
            ...
            >
              <span
                className={`w-2 h-2 rounded-full ${currentStatus.color} status-dot`}
              ></span>
