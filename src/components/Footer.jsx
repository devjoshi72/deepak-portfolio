...
export default function Footer({ onOpenTerminal }) {
  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800 text-slate-400 font-mono text-xs py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-800 border border-emerald-500/40 text-emerald-400 hover:bg-slate-700 transition-colors cursor-pointer font-bold"
              >
              ...
              <a
                ...
                className="p-2.5 rounded-xl bg-slate-800 border border-slate-700 text-slate-300 hover:text-cyan-400 hover:border-cyan-400 transition-colors"
                title="LinkedIn"
              >
                <LinkedinIcon className="w-4 h-4 fill-cyan-400" />
              </a>
        ...
        {/* Bottom Bar */}
        <div className="pt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-[11px] text-slate-400">
          <div>
